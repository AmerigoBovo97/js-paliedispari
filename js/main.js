    //html variables
    const palindromResult = document.getElementById("palindrom-result"); // html element for the palindrome result output
    const choosenWord = document.getElementById("word-to-check"); // html element for the word input
    const wordSubmit = document.getElementById("palindrom-button"); // html element for the word input submit
    ...
    const numberSubmit = document.getElementById("word-to-check"); // html element for the number input submit
